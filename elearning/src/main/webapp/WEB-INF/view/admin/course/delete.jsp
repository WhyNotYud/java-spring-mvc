                ...
                <div class="mt-5">
                    <div class="row">
                        <div class="col-12 col-md-7 mx-auto">
                            ...
                            <%--@elvariable id="deleteCourse" type=""--%>
                            <form:form action="/admin/course/delete" method="post" modelAttribute="deleteCourse">
                                <div class="mb-3" style="display: none;">
                                    <label class="form-label">ID:</label>
                                    <form:input type="text" class="form-control" path="id" value="${id}"/>
                                </div>
                                <button class="btn btn-danger">Confirm</button>
                                <a href="/admin/course" class="btn btn-success float-end">Back</a>
                            </form:form>
                        </div>
                    </div>
                </div>
